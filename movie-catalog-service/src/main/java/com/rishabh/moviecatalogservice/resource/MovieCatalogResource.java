...
public class MovieCatalogResource {
    ...
    public List<CatalogItem> getCatalog(@PathVariable("userId") String userId){
        ...
        UserRating ratingsList = restTemplate.getForObject("http://localhost:8183/ratingsdata/user/"+ userId, UserRating.class);
        ...
        return ratingsList.getRatings().stream()
                .map(rating -> {
                    Movie movie = restTemplate.getForObject("http://localhost:8182/movies/" + rating.getMovieId(), Movie.class);
